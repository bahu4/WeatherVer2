...
public interface HistoryDAO {
    ...
    @Query("SELECT ID, DATE, NAME, TEMPERATURE, WEATHER, WINDSPEED, PRESSURE, WINDDIR FROM HISTORY")
    Cursor getHistories();

    @Query("SELECT ID, DATE, NAME, TEMPERATURE, WEATHER, WINDSPEED, PRESSURE, WINDDIR FROM HISTORY WHERE ID=:id")
